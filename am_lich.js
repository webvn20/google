...
function printStyle()
{
   ...
   res += '  .navi-l {text-align:center; font-size:100%; line-height:100%; font-family:Verdana,Times New Roman,Arial; font-weight:bold; color:red; background-color: #EAEAEA}\n';
   res += '  .navi-r {text-align:center; font-size:100%; line-height:100%; font-family:Verdana,Arial,Times New Roman; font-weight:bold; color:#330033; background-color: #EAEAEA}\n';
   ...
   res += '  .homnay {text-align:center; font-size:200%; color:red; background-color:#EAEAEA}\n';
   res += '  .tet {background-color:#FFCC99}\n';
   res += '  .am {text-align:right;font-size:100%;line-height:100%;color:blue}\n';
   res += '  .am2 {text-align:right;font-size:100%;line-height:100%;color:#004080}\n';
   res += '  .t2t6 {text-align:left;font-size:150%;color:black}\n';
   res += '  .t7 {text-align:left;font-size:150%;line-height:100%;color:green}\n';
   res += '  .cn {text-align:left;font-size:150%;line-height:100%;color:red}\n';
   res += '-->\n';
   res += '</style>\n';
   return res;
}
...
{
   var res = "";
   res += '<script language="JavaScript" src="js/am_lich.js"></script>\n';
   return res;
}
...
{
   var home = "http://shimivn.blogspot.com";
