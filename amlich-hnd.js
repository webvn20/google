...
ret += '<div class="khung_lich">';

ret += '<div class="khung_lich_duong">';
  ret += '<div id="thangduong">Tháng '+solarMonth+'</div>';
  ret += '<div id="namduong">Năm '+solarYear+'</div>';
  ret += '<div id="ngayduong">'+solarDay+'</div>';
  ret += '<div id="thuduong">'+dayOfWeek+'</div>';
  ret += '<div id="dayinfo">'+getDayInfo(dd, mm)+'</div>';
  ret += '<div title="'+info+'"></div>';
ret += '</div>';
  ret += '<div id="khung_am">';

﻿  ret += '<div id="ngayleft">';
﻿  ret += '<div id="thangam">Th\u00E1ng '+thangAm+'</div>';
﻿  ret += '<div id="ngayam">'+dd+'</div>';
﻿  ret += '<div id="namam">N\u0103m '+getYearCanChi(yy)+'</div>';
﻿  ret += '</div>';

﻿  ret += '<div id="ngayright">\n';
﻿  ret += '<div id="canchithang" >Tháng '+thang+'</div>';
﻿  ret += '<div id="canchingay" >Ngày '+ngay+'</div>';
﻿  ret += '<div id="canchigio" >Giờ '+getCanHour0(jd)+' T\375</div>';
   ret += '</div>';
   ret += '<div id="khung_tietkhi">';
﻿  ret += '<div id="tietkhi" >Tiết '+TIETKHI[getSolarTerm(jd+1, 7.0)]+'</div>';
﻿  ret += '<div id="hoangdao">Giờ Hoàng Đạo '+getGioHoangDao(jd)+'</div>\n';
﻿  ret += '</div>';
