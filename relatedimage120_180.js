...
if(relatedTitles[relatedTitlesNum].length>180) relatedTitles[relatedTitlesNum]=relatedTitles[relatedTitlesNum].substring(0, 180)+"...";
...
document.write('<li><a');
document.write(' href="' + relatedUrls[r] + '"><img style="width:120px;height:130px;border:0px;" src="'+thumburl[r]+'"/><span class="overlay" >'+relatedTitles[r]+'</span></a></li>');
